...
public interface UIObjectListController<PageType, DataSource> {
	...
	UIObjectListController<PageType, DataSource> setDragStartEnabled(boolean dragEnabled);

	UIObjectListController<PageType, DataSource> setDragEndEnabled(boolean dragEnabled);
