...
import org.parent.refreshview.widget.RefreshLoadCallback;
...
public class UIViewMethod<V extends View> extends AbsUIViewMethod<V> {
	...
	public UIRefreshViewMethod methodAtRefreshView() {
		return this.get(UIRefreshViewMethod.class);
	}
	...
	public static class UIRefreshViewMethod extends UIViewMethod<RefreshView> {

		protected UIRefreshViewMethod(@NonNull UIViewController controller, @Nullable RefreshView preView) {
			super(controller, preView);
		}

		public UIRefreshViewMethod setRefreshing(boolean refreshing, long delayMillis) {
			this.getPreView().setRefreshing(refreshing, delayMillis);
			return this;
		}

		public UIRefreshViewMethod setRefreshing(boolean refreshing) {
			this.getPreView().setRefreshing(refreshing);
			return this;
		}

		public UIRefreshViewMethod setDragStartEnabled(boolean dragEnabled) {
			this.getPreView().setDragStartEnabled(dragEnabled);
			return this;
		}

		public UIRefreshViewMethod setDragEndEnabled(boolean dragEnabled) {
			this.getPreView().setDragEndEnabled(dragEnabled);
			return this;
		}

		public UIRefreshViewMethod setOrientation(int orientation) {
			this.getPreView().setOrientation(orientation);
			return this;
		}

		public UIRefreshViewMethod setRefreshMode(RefreshMode refreshMode) {
			this.getPreView().setRefreshMode(refreshMode);
			return this;
		}

		public UIRefreshViewMethod setOnRefreshListener(RefreshView.OnRefreshListener listener) {
			this.getPreView().setOnRefreshListener(listener);
			return this;
		}

		public UIRefreshViewMethod addOnScrollListener(RefreshView.OnScrollListener listener) {
			this.getPreView().addOnScrollListener(listener);
			return this;
		}

		public UIRefreshViewMethod removeOnScrollListener(RefreshView.OnScrollListener listener) {
			this.getPreView().removeOnScrollListener(listener);
			return this;
		}

		public UIRefreshViewMethod setOnChildScrollCallback(RefreshView.OnChildScrollCallback callback) {
			this.getPreView().setOnChildScrollCallback(callback);
			return this;
		}

		public UIRefreshViewMethod setFrictionRatio(@FloatRange(from = 0.1f, to = 1.f) float frictionRatio) {
			this.getPreView().setFrictionRatio(frictionRatio);
			return this;
		}

		public <Callback extends RefreshLoadCallback> UIRefreshViewMethod setHeaderLoadCallback(@NonNull Callback callback) {
			this.getPreView().setHeaderLoadCallback(callback);
			return this;
		}

		public <Callback extends RefreshLoadCallback> UIRefreshViewMethod setFooterLoadCallback(@NonNull Callback callback) {
			this.getPreView().setFooterLoadCallback(callback);
			return this;
		}

		public UIRefreshViewMethod setHeaderLoadAnimStyle(@RefreshLoadCallback.AnimStyleMode int animStyle) {
			this.getPreView().getHeaderLoadCallback().setAnimStyle(animStyle);
			return this;
		}

		public UIRefreshViewMethod setFooterLoadAnimStyle(@RefreshLoadCallback.AnimStyleMode int animStyle) {
			this.getPreView().getFooterLoadCallback().setAnimStyle(animStyle);
			return this;
		}

		public UIRefreshViewMethod setHeaderRefreshTips(boolean refreshTips) {
			this.getPreView().getHeaderLoadCallback().setRefreshTips(refreshTips);
			return this;
		}

		public UIRefreshViewMethod setFooterRefreshTips(boolean refreshTips) {
			this.getPreView().getFooterLoadCallback().setRefreshTips(refreshTips);
			return this;
		}
	}
}
