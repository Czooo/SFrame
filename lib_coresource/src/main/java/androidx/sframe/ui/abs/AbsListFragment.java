 ...
 * Email : ok@163.com.
 */
public abstract class AbsListFragment<DataSource> extends AbsFragment implements UIObjectListController.OnDataSourceListener, RecyclerAdapterController.Delegate<DataSource> {
